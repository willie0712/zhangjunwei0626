const translations = {
  zh: {
    ...
    blogOneMeta: "攝影日常",
    blogOneTitle: "雨港街頭的光",
    blogOneDesc: "在基隆的雨天裡找光、找故事，也找下一張值得留下的照片。",
    blogTwoMeta: "剪輯練習",
    ...
    photographyDesc: "熟練度高。喜歡捕捉街景、人像與生活瞬間。",
    editingTitle: "✂️ 影片剪輯",
    ...
    albumYilanTitle: "🚌 二信高中校外教學 · 宜蘭（2025.05.09）",
    ...
    mobileGamesTitle: "📱 手機遊戲",
    gameSpeedTitle: "極速領域",
    gameSpeedMeta: "競速 · 2022/12-2026/4",
    gameRobloxTitle: "Roblox",
    gameRobloxMeta: "沙盒 · 2019/12-現在",
    gameWeplayTitle: "WePlay",
    gameWeplayMeta: "派對 · 2024/12-2026/4 (約2年)",
    pcGamesTitle: "💻 電腦遊戲",
    gameAsphaltTitle: "Asphalt 9",
    gameAsphaltMeta: "競速 · 2025-現在",
    gameMinecraftTitle: "Minecraft",
    gameMinecraftMeta: "創造 · 2022-現在",
    gamePixelTitle: "Pixel Gun 3D",
    gamePixelMeta: "射擊 · 2025-現在",
    gameSpeedDesc: "追求極速甩尾的快感，享受在賽道上零點幾秒的博弈。",
    gameRobloxDesc: "自由度極高的世界，在這裡和朋友們留下了超多搞笑和冒險的回憶。",
  ...
  en: {
    ...
    blogOneTitle: "Light on the Rainy Streets",
    blogOneDesc: "Finding light, stories, and the next photo worth keeping in Keelung's rainy days.",
    ...
    photographyDesc: "Highly skilled. I love capturing streets, portraits, and everyday moments.",
    editingTitle: "✂️ Video Editing",
    ...
    albumYilanTitle: "🚌 Erxin High School Field Trip · Yilan (2025.05.09)",
    ...
    mobileGamesTitle: "📱 Mobile Games",
    gameSpeedTitle: "Speed Drifters",
    gameSpeedMeta: "Racing · 2022/12-2026/4",
    gameRobloxTitle: "Roblox",
    gameRobloxMeta: "Sandbox · 2019/12-Present",
    gameWeplayTitle: "WePlay",
    gameWeplayMeta: "Party · 2024/12-2026/4 (about 2 years)",
    pcGamesTitle: "💻 PC Games",
    gameAsphaltTitle: "Asphalt 9",
    gameAsphaltMeta: "Racing · 2025-Present",
    gameMinecraftTitle: "Minecraft",
    gameMinecraftMeta: "Creative · 2022-Present",
    gamePixelTitle: "Pixel Gun 3D",
    gamePixelMeta: "Shooter · 2025-Present",
    gameSpeedDesc: "Chasing the thrill of drifting and competing for split-second victories on the track.",
    gameRobloxDesc: "A world of ultimate freedom where I made countless hilarious and adventurous memories with friends.",
...
function applyLanguage(lang) {
  ...
  if (musicToggle) {
    ...
    if (isPlaying) {
      musicToggle.innerHTML = `<span class="music-icon">🔊</span><span class="music-text">${dictionary.musicStop || '關閉音樂'}</span>`;
    } else {
      musicToggle.innerHTML = `<span class="music-icon">🎵</span><span class="music-text">${dictionary.musicPlay || '播放音樂'}</span>`;
    }
  }

  langButton.textContent = lang === "zh" ? "中文 / EN" : "EN / 中文";
  localStorage.setItem("willie-site-lang", lang);
}

langButton.addEventListener("click", () => {
  const current = localStorage.getItem("willie-site-lang") || "zh";
...
if (musicToggle && musicContainer) {
  musicToggle.addEventListener('click', function() {
    ...
    const currentLang = localStorage.getItem("willie-site-lang") || "zh";
    const dict = translations[currentLang] || translations.zh;
    
    if (musicPlaying) {
      musicContainer.style.display = 'block';
      musicToggle.classList.add('playing');
      musicToggle.innerHTML = `<span class="music-icon">🔊</span><span class="music-text">${dict.musicStop || '關閉音樂'}</span>`;
    } else {
